...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('app', '<h1>{opts.title}</h1> <input type="text" id="nameInput" placeholder="Name" onkeyup="{edit}"> <input type="text" id="ageInput" placeholder="Age" onkeyup="{edit}"> <button onclick="{add}">Add</button> <ul> <li each="{person in opts.people}">{person.name} - {person.age}</li> </ul>', '', '', function (opts) {
	  var self = this;
	  self.disabled = true;
	  self.mixin('store');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = {
	  ...
	  */
	  ...
	  observable: _riot2['default'].observable()
	};
